...
class DownCaster :
    ...
    def optimize(self, df: pl.DataFrame) -> pl.DataFrame:
        """
        The downcasting logic:
            Types = [Int64, Float64] 
            for each type :
                ima implement a method that does the infering
            then for the entire df, iterate over columns and apply optimization based of the column type
        """
